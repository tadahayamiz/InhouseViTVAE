# ihvit
a repository for in-house ViT-VAE implementation based on the followings:  
- [origin](https://github.com/media-sec-lab/ViT-VAE)  
...
------------  
    ...
    │  
    └── ihvitvae            <- Source code for use in this project  
        ├── __init__.py     <- Makes src a Python module  
        │  
        ├── main.py         <- main CLI for this module  
        │  
        ├── ihvitvae.py     <- a Python module  
        │  
